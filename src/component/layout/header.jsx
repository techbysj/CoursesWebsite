...
const img = "/assets/images/logo/sjlogo.png"
const phoneNumber = "+254 100 100 172";
const address = "Nkrumah Road, Mombasa, Kenya.";
            ...
            <div className="header-bottom">
                <div className="container">
                    <div className="header-wrapper">
                        <div className="logo">
                            <Link to="/">
                                <img src="assets/images/logo/sj1.png" alt="logo" />
                                {/* <img src="assets/images/logo/sjlogo.png" alt="logo" /> */}
